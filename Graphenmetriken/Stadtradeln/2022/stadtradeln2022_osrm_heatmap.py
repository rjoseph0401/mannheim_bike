...
#Path anpassen!
INPUT_FILE = Path("stadtradeln_2022.xlsx")
PARQUET    = Path("cache/stadtradeln_2022.parquet")
CACHE_FILE = Path("cache/stadtradeln2022_osrm_routes.json")
...
GEOJSON_OUT = Path("stadtradeln2022_osrm_routes.geojson")
...
m.save("stadtradeln2022_osrm_heatmap_new.html")
