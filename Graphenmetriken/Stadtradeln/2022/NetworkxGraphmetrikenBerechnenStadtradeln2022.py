...
# Matrix laden
adj_matrix = sp.load_npz("adjacency_matrixStadtradeln2022.npz")
...
node_index = pd.read_csv("node_indexStadtradeln2022.csv")
...
fig.savefig("graph_filtered_Stadtradeln2022.png", dpi=300, bbox_inches="tight")
plt.show()
...
print(node_index)
node_index.to_csv("Stadtradeln2022nodes_OSRMwithmetrics.csv")
