...
# Matrix laden
adj_matrix = sp.load_npz("adjacency_matrixStadtradeln2024.npz")
...
node_index = pd.read_csv("node_indexStadtradeln2024.csv")
...
print(node_index)
node_index.to_csv("Stadtradeln2024nodes_OSRMwithmetrics.csv")
