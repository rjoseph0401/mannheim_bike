...
# Matrix laden
adj_matrix = sp.load_npz("adjacency_matrixStadtradeln2023.npz")
...
node_index = pd.read_csv("node_indexStadtradeln2023.csv")
...
fig.savefig("graph_filtered_Stadtradeln2024.png", dpi=300, bbox_inches="tight")
plt.show()
...
print(node_index)
node_index.to_csv("Stadtradeln2023nodes_OSRMwithmetrics.csv")

#print("Communicability")
#Communicability = nx.communicability_betweenness_centrality(G_sub_undirected)
#print(Communicability)
