...
# Matrix laden
adj_matrix = sp.load_npz("adjacency_matrixGraphhopper.npz")
...
node_index = pd.read_csv("node_indexGraphhopper.csv")
...
ax.set_title("Gefilterter Graph (nur Knoten mit GraphhopperRouten)")
...
print(node_index)
node_index.to_csv("nodes_Graphhopperwithmetrics.csv")
