...
OUTPUT_FILE = RESULTS_DIR / f"{RUN_TAG}_heatmap_softspread_calibrated.png"

# ============================================================
# Parameter
# ============================================================

SCALE_MODE = "share"   # "city_classes", "percentile", "share"
...
# Fallback, wenn für eine Route gar nichts im Soft-Matching landet
...
if SCALE_MODE == "percentile":
    ...
    norm = colors.LogNorm(vmin=vmin, vmax=vmax)
    cbar_label = "Kalibrierter Anteil am Gesamtfluss (log)"
...
for (u, v, k), val in plot_hits.items():
    ...
    if SCALE_MODE == "city_classes":
        ...
        line_color = CUSTOM_CMAP(norm(val))
